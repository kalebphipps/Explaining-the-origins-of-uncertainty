...
class QuantileSmallExogenousNetwork(nn.Module):
...
def train_small_exogenous_quantile_model(model, history, target, hour_cos, hour_sin, day_cos, day_sin, month_cos,
...
def create_small_exogenous_quantile_predictions(model, history, hour_cos, hour_sin, day_cos, day_sin, month_cos,
                                                month_sin, feature1, feature2):
    model.eval()
    with torch.no_grad():
