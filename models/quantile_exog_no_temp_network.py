...
class QuantileExogenousNoTemporalNetwork(nn.Module):
...
def train_exogenous_no_temp_quantile_model(model, history, target, feature1, feature2, feature3, num_epochs, batch_size,
...
def create_exogenous_no_temp_quantile_predictions(model, history, feature1, feature2, feature3):
    model.eval()
    with torch.no_grad():
